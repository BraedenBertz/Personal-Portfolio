...
function NavMenuItems({ show }) {
    ...
    const github = (
        <svg xmlns="http://www.w3.org/2000/svg" stroke="white" fill='none'
            className="w-8 h-8" width="16" height="16" viewBox="0 0 16 16">
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
    ...
    const buttonCss = 'left--20 mt-2 h-8 bg-[#B200AC] dark:bg-[#B200AC] text-lg px-1 \
        ...
        <>
            <div className='flex flew-row gap-5'>
                <button type="button" onClick={handleThemeSwitch}
                    className={(show ? 'visibility: hidden' : 'left-20 mt-2 h-8 bg-violet-300 dark:bg-orange-300 text-lg px-1\
                ...
                <span className='hidden peer-hover/Theme:block mt-3 text-white'> Change Theme </span>
                <span className='hidden peer-hover/LinkedIn:block mt-3 text-white'> LinkedIn </span>
                <span className='hidden peer-hover/Github:block mt-3 text-white'> Github </span>
                <span className='hidden peer-hover/Resume:block mt-3 text-white'> Resume </span>
            </div >
        </>
    )
}
